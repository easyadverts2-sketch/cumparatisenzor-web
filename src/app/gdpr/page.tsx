  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-14">
      ...
      <p className="mt-4 text-[#14534d]">
        Acest document descrie modul in care prelucram datele personale. Pentru versiune finala adaptata
        complet legislatiei, consultati un specialist GDPR.
      </p>
      ...
      <p className="mt-2 text-[#14534d]">
        Colectam nume, adresa de facturare si livrare, e-mail, telefon si detalii despre comanda, strict
        pentru procesarea, livrarea si comunicarea legata de comanda.
      </p>
      <h2 className="mt-8 text-xl font-semibold text-[#042f2c]">Temei legal</h2>
      <p className="mt-2 text-[#14534d]">
        Executarea contractului, obligatii legale (ex. facturare acolo unde este cazul) si interesul legitim
        de a raspunde solicitarilor dumneavoastra.
      </p>
