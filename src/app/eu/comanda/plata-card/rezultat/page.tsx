...
export const metadata: Metadata = {
  title: "Результат оплаты картой",
  robots: NOINDEX_PAGE,
};

export default function EuCardPaymentResultPage({
  searchParams,
}: {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      <StripePaymentResult market="EU" orderNumber={nr} pendingId={pendingId || undefined} />
    </main>
  );
}
