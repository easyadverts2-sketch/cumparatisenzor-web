...
export default function EuThanksUaPage({
  searchParams,
}: {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-center">
      <div className="rounded-3xl border-2 border-[#0d9488]/30 bg-gradient-to-b from-[#e6f7f4] to-white px-8 py-12 shadow-lg">
        <h1 className="mt-2 text-2xl font-bold text-[#0a2624]">Дякуємо за замовлення!</h1>
        {nr ? <p className="mt-3 text-lg font-semibold text-[#0f766e]">Номер замовлення: {nr.padStart(7, "0")}</p> : null}
        <p className="mt-6 text-[#1a4d47]">Замовлення прийнято, незабаром надішлемо підтвердження на e-mail.</p>
