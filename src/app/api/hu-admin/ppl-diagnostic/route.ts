...
export async function GET(request: NextRequest) {
  ...
  const diagnostic: Record<string, unknown> = {
    ...
    pplLabelUrl: refreshed.pplLabelUrl,
    pplCompleteLabelUrl: refreshed.pplCompleteLabelUrl,
    pplCancelMode: refreshed.pplCancelMode,
    pplCancelAttempted: refreshed.pplCancelAttempted,
    pplCancelShipmentNumber: refreshed.pplCancelShipmentNumber,
    pplCancelHttpStatus: refreshed.pplCancelHttpStatus,
    pplCancelResponse: refreshed.pplCancelResponse,
    pplLocalResetDone: refreshed.pplLocalResetDone,
    cachedImportState: order.pplImportState,
    currentImportState: refreshed.pplImportState,
    currentBatchStatusHttp: refreshed.pplLastHttpStatus,
