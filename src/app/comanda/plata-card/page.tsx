      ...
      <div className="rounded-3xl border-2 border-[#de6a44]/30 bg-white p-8 shadow-lg">
        ...
        {pendingId ? (
          <p className="mt-2 text-sm text-[#6b3b4d]">
            Comanda se inregistreaza in sistem abia dupa confirmarea platii cu succes.
          </p>
        ) : nr ? (
          <p className="mt-2 font-semibold text-[#be3f6f]">{`Comanda nr. ${nr}`}</p>
        ) : null}
        ...
        <div className="mt-6">
          {pendingId ? (
            ...
            <p className="rounded-lg bg-red-50 px-4 py-3 text-sm text-red-700">
              Lipsesc datele necesare pentru plata cu cardul (sesiune invalida sau expirata).
            </p>
          )}
        </div>
